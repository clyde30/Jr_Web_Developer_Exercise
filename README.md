...
- The data needs to come through some sort of data layer. In other words, we don't want the text hard coded in the web pages. Show us that you understand how to use a Data Access layer (DAL). You should be able to use the JSON feed for the source of your data.
- The front end logic of the site should include the use of some sort of JavaScript framework (i.e. JQuery, Backbone, Angular, Bootstrap)

##Delivery##
When you are finished, submit a pull request. If there is any configuration that needs to be done, please note that in your pull request. Also please provide instructions for how we can "run" your web application (i.e. Run Index.html to begin browsing the site).
